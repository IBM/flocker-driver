...
class IBMStorageIProfiledBlockDeviceAPITestsMixin(
    ...
    Important:
    IBM Storage plug-in for Flocker does not require Gold, Silver and Bronze profiles.
    ...
    storage services must be defined and delegated to the Flocker interface on SCBE.
    """
